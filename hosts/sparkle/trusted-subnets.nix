# Client subnets trusted to reach admin surfaces (Caddy vhosts, forgejo git-ssh, VM ICMP, iperf3): LAN (10.28.64.0/24), WireGuard VPN (10.28.96.0/24), Nox's LAN (10.100.0.0/24), Nox's WireGuard (10.1.0.0/24).
